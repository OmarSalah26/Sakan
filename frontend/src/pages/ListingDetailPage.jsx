    ...
    <div className="detail-page-container">
      ...
      <div style={{ background: '#fff', border: '1px solid var(--border)', borderRadius: '16px', padding: '1.5rem', marginBottom: '1.5rem' }}>
        ...
        {(() => {
          ...
          const INDOOR_GROUPS = [
            { title: "تجهيزات الشقة", items: ["مكيفة", "مروحة", "تلفزيون", "مكتب للمذاكرة", "كرسي مكتب", "دولاب ملابس", "سخان", "غسالة", "منشر ملابس", "مكواة", "واي فاي", "حمام خاص", "مياه"] },
            { title: "المطبخ", items: ["مطبخ", "ثلاجة", "بوتاجاز", "ميكروويف", "أجهزة مطبخ", "أطباق وأدوات مائدة", "غاز طبيعي"] },
          ...
          const OUTDOOR_GROUPS = [
            { title: "الخدمات الأساسية القريبة", items: ["سوبر ماركت", "مخبز", "صيدلية", "مستشفى", "بنك", "ماكينة صراف آلي (ATM)", "موقف سيارات"] },
